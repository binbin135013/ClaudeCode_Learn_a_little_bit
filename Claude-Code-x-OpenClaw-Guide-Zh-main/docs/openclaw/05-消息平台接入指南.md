...
> 🟡 **难度：进阶** | ⏱️ 阅读时间：20 分钟 | 📋 前置知识：已完成快速开始（[03-快速开始指南](03-快速开始指南.md)）
>
...
飞书作为 extension，配置方式请参考 OpenClaw 源码中的 `docs/channels/feishu.md`。基本需要在飞书开放平台获取 App ID 和 App Secret，然后在 OpenClaw 配置中设置。
...
> **概念性说明**：以下 TypeScript 接口是对 Channel 系统的概念性描述，帮助理解其设计思路。实际接口可能与此不完全一致，请以 OpenClaw 源码为准。
