...
Skill 是 Claude Code 的**顶层能力封装**机制，基于 Hook 系统构建，提供可被用户直接调用的功能单元。

> [!note] Superpowers 基于 Skill
> Superpowers 是 Skill 的高级扩展集，提供了 TDD、调试、头脑风暴等专业开发方法论。详见 [[../17-Superpowers/17-01-🚀-Superpowers入门]]。它是一种**声明式**的能力扩展方式，允许开发者将复杂的工作流封装为可复用的技能模块。
...
> [!note]- 关联知识
> [[../02-Tool系统/02-01-🔧-Tool系统]] - Skill 调用 Tool 系统执行具体操作
...
> [!note]- 关联知识
> [[../03-权限系统/03-01-🔐-权限系统]] - Skill 执行时需要权限验证才能调用工具

> [!note]- 关联知识
> [[../05-记忆系统/05-01-🧠-记忆系统]] - Skill 可通过记忆系统持久化状态
...
- [[../04-Hook系统/04-01-🪝-Hook系统]] - Skill 基于 Hook 构建
- [[../09-子Agent与协作/09-01-🤝-子Agent与协作]] - Agent 间协作
- [[../01-架构总览/01-01-📐-架构概览]] - Skill 在架构中的位置
