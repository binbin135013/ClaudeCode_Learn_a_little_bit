...
> [!note] Hook与权限深度关联
> Hook系统与权限系统紧密集成：`PermissionRequest` 和 `PermissionDenied` 是 Hook 的生命周期事件，Hook 可以拦截权限决策。详见 [[../04-Hook系统/04-01-🪝-Hook系统]]。
...
- [[../02-Tool系统/02-01-🔧-Tool系统]] - 被权限保护的对象
- [[../04-Hook系统/04-01-🪝-Hook系统]] - Hook 也能介入权限
- [[../10-设计模式/10-01-♻️-核心设计模式]] - 管道模式

> [!note]- 关联知识
> 权限系统的四阶段管道是经典的责任链模式应用。详见 [[../10-设计模式/10-01-♻️-核心设计模式]]。
...
| 内容 | 来源 |
|-----|------|
| **四阶段管道**（Schema验证→规则匹配→上下文评估→交互确认） | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) 源码分析 |
| **三级权限模型**（Allow/Ask/Deny）及配置层次 | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) 主教材 |
| **沙箱配置**（filesystem allow/deny、路径遍历防护） | [claude-code-best/claude-code](https://github.com/claude-code-best/claude-code) 企业级实现 |
| **断路器机制**（CircuitBreaker、3次失败阈值） | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) |
| **权限模式光谱**（bypass→default）及 auto 模式三层优化 | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) |
| **七层规则优先级**（session > command > ... > user） | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) |
| **ResolveOnce 原子竞争解决** | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) |
| **Bash 精细权限控制**（精确/前缀/通配符匹配） | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) |
...
- [claude-code-best/claude-code](https://github.com/claude-code-best/claude-code)（企业级实现，8,712 stars）