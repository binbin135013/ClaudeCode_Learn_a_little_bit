...
- [[../11-QueryEngine/11-01-⚙️-QueryEngine]] - Agent运行的环境基础
- [[../08-Skill系统/08-01-📚-Skill系统]] - Team Skill基于此实现
- [[../10-设计模式/10-01-♻️-核心设计模式]] - Fork/Coordinator模式

### 工具与权限

> [!note]- 关联知识
> [[../02-Tool系统/02-01-🔧-Tool系统]] - 工具白名单

> [!note]- 关联知识
> [[../03-权限系统/03-01-🔐-权限系统]] - 权限包装
...
> | 知识点 | 来源 |
> |-------|------|
> | **Fork模式** | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) - 子Agent机制与并行执行 |
> | **提示缓存共享** | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) - 上下文管理与缓存优化 |
> | **Coordinator模式** | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) - 多Agent编排策略 |
> | **Team Memory** | [claude-code-best/claude-code](https://github.com/claude-code-best/claude-code) - 企业级多Agent协作实现 |
> | **工具白名单** | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) - 权限系统设计 |
> | **写入互斥机制** | [claude-code-best/claude-code](https://github.com/claude-code-best/claude-code) - 并发控制实现 |
>
> 参考教材：
> - [主教材 lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book)（1,190 stars）
> - [源码分析 liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis)（537 stars）
> - [企业级实现 claude-code-best/claude-code](https://github.com/claude-code-best/claude-code)（8,712 stars）
