...
| 意图类型 | 特征关键词 | 对应Skill |
|---------|-----------|-----------|
| **快速实现** | "做出来"、"实现"、"完成" | [[📚-Skill系统\|autopilot]] |
| **迭代优化** | "优化"、"改进"、"直到..." | [[📚-Skill系统\|ralph]] |
| **并行处理** | "并行"、"同时"、"批量" | [[📚-Skill系统\|ultrawork]] |
| **协作探索** | "团队"、"协作"、"分析" | [[📚-Skill系统\|team]] |
...
| 需求 | → | Skill | 触发词 |
|------|---|-------|--------|
| 端到端实现 | → | [[📚-Skill系统\|autopilot]] | `autopilot` |
| 持续修正直到完成 | → | [[📚-Skill系统\|ralph]] | `ralph` |
| 高吞吐量并行任务 | → | [[📚-Skill系统\|ultrawork]] | `ulw`, `ultrawork` |
| 多Agent团队协作 | → | [[📚-Skill系统\|team]] | `team` |
| 三模型综合分析 | → | [[📚-Skill系统\|ccg]] | `ccg` |
| QA循环验证 | → | [[📚-Skill系统\|ultraqa]] | `ultraqa` |
| 战略规划 | → | [[📚-Skill系统\|plan]] | `plan` |
| 深度研究 | → | [[📚-Skill系统\|sciomc]] | `sciomc` |
| 需求澄清 | → | [[📚-Skill系统\|deep-interview]] | `deep interview` |
| 模型路由 | → | [[📚-Skill系统\|ask]] | `ask` |
| 知识固化 | → | [[📚-Skill系统\|learner]] | `learner` |
...
- [[🔄-Ralph循环最佳实践]] - Ralph循环详解
- [[💡-Deep-Interview工作流]] - 需求澄清工作流
- [[🤖-Team协作拓扑]] - Team协作模式
