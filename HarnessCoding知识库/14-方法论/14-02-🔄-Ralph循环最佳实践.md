...
| 场景 | 原因 | 推荐替代 |
|------|------|---------|
| 需求模糊 | 无法验证成功 | [[14-04-💡-Deep-Interview工作流\|deep-interview]] |
| 一次性任务 | 不需要迭代 | [[14-01-🎯-Skill选择决策树|autopilot]] |
| 纯并行任务 | 无依赖关系 | [[14-01-🎯-Skill选择决策树|ultrawork]] |
| 需要规划 | 方向不清晰 | [[14-01-🎯-Skill选择决策树|plan]] |
...
> [!note]- 关联知识
> [[../17-Superpowers/17-01-🚀-Superpowers入门]] - Superpowers增强Ralph循环效率
