...
> [!note]- 关联知识
> SubagentStart 和 SubagentStop 是多 Agent 协作的生命周期事件。详见 [[../09-子Agent与协作/09-01-🤝-子Agent与协作]]。
...
> [!note]- 关联知识
> PreCompact 和 PostCompact 事件与上下文压缩机制紧密相关。详见 [[../06-上下文管理/06-01-📦-上下文管理]]。
...
- [[../08-Skill系统/08-01-📚-Skill系统]] - Skill 基于 Hook 构建
- [[../03-权限系统/03-01-🔐-权限系统]] - 权限与 Hook 深度集成（PermissionRequest/PermissionDenied 事件）
- [[../11-QueryEngine/11-01-⚙️-QueryEngine]] - Hook 嵌入引擎
- [[../10-设计模式/10-01-♻️-核心设计模式]] - 拦截器模式
- [[../02-Tool系统/02-01-🔧-Tool系统]] - 被 Hook 拦截的工具
- [[00-01-🏠-知识库首页]] - 返回首页
