...
> [!note] OMC 运行在 Claude Code 架构上
> oh-my-claudecode (OMC) 是基于 Claude Code 架构构建的多智能体编排框架，充分利用 CC 的 QueryEngine、Tool、Hook 等核心系统。详见 [[../13-OMC完全指南/13-01-🏁-OMC入门]]。
...
| 组件 | 职责 | 关联 |
|-----|------|-----|
| [[../11-QueryEngine/11-01-⚙️-QueryEngine]] | AI 对话核心引擎 | 所有系统的中枢 |
| [[../02-Tool系统/02-01-🔧-Tool系统]] | 能力扩展接口 | 被 QueryEngine 调用 |
| [[../03-权限系统/03-01-🔐-权限系统]] | 安全边界 | 包装 Tool 调用 |
| [[../05-记忆系统/05-01-🧠-记忆系统]] | 长期记忆存储 | 被 QueryEngine 使用 |
| [[../04-Hook系统/04-01-🪝-Hook系统]] | 生命周期扩展 | 嵌入各系统 |
| [[../08-Skill系统/08-01-📚-Skill系统]] | 顶层能力封装 | 基于 Hook 构建 |
...
- [[../02-Tool系统/02-01-🔧-Tool系统]] - 工具如何工作（最常用）
- [[../03-权限系统/03-01-🔐-权限系统]] - 安全如何保证（必须了解）
- [[../04-Hook系统/04-01-🪝-Hook系统]] - 扩展机制（进阶可选）
...
> | 内容 | 来源 |
> |-----|------|
> | **核心组件与架构概览** | [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) - 主教材，1,190 Stars |
> | **五大设计原则（深度解析）** | lintsinghua/claude-code-book 第一篇分析 |
> | **六大核心系统** | [liuup/claude-code-analysis](https://github.com/liuup/claude-code-analysis) - 源码分析，537 Stars |
> | **六层配置优先级** | Claude Code 源码分析 |
> | **关键数字与技术栈** | Claude Code 源码统计（约1,902文件，512K+行） |
> | **十种设计模式速查** | [claude-code-best/claude-code](https://github.com/claude-code-best/claude-code) - 企业级参考，8,712 Stars |